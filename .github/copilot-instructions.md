...
## Repository-Specific Focus (Shared Bundle)

- Treat this package as a shared contract layer consumed by all backend services.
- Public API changes in shared classes, traits, enums, and exceptions should be assumed breaking until verified downstream.
- Prefer additive and backward-compatible changes over in-place signature changes.
- After shared-bundle updates, smoke validation is mandatory because regressions usually surface in service integration.
